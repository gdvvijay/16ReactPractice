...
// Resolution: Resolves with an array of results when all input promises resolve.

// Rejection: Rejects immediately if any input promise rejects.

// Order: The order of the results in the resolved array is guaranteed to match the order of the promises in the input array.
